...
# install nginx
RUN cd /usr/src/install/nginx-1.24.0 && ./configure --prefix=/usr/local/nginx --with-http_stub_status_module --with-http_ssl_module --with-pcre --with-zlib --with-openssl=/usr/src/install/openssl-1.1.1l
